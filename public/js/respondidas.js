...
(() => {
/*!************************************************!*\
  !*** ./resources/js/backoffice/respondidas.js ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
...
chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart.register.apply(chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart, _toConsumableArray(chart_js__WEBPACK_IMPORTED_MODULE_0__.registerables)); // Gráfico de cada Tentativa

var ctx = document.getElementById('myChart').getContext('2d');
var data = document.querySelectorAll('.resultCategoriasDisplay');
var categorias = [];
var medias = [];
data.forEach(function (e) {
  var separate = e.innerText.split('\n');
