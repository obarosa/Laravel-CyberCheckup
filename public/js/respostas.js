...
(() => {
/*!**********************************************!*\
  !*** ./resources/js/backoffice/respostas.js ***!
  \**********************************************/
...
$(document).ready(function () {
  ...
  var dtable = new DataTable('#tableRespostas', {
    searching: true,
    select: false,
    paging: false,
    info: false,
  ...
  function updateOrder(aData) {
    axios.post('/respostas/order', {
      ...
      var linhaOrdemResp = document.querySelectorAll('.linhaOrdemResp');
      var i = 1;
      linhaOrdemResp.forEach(function (e) {
...
modalGuardarResposta.btn.guardar.addEventListener('click', function () {
  var nome = modalGuardarResposta.inputNome;
  var pontos = null;
  ...
  var questaoid = modalGuardarResposta.labelIdQuest.getAttribute('questId');
  var respostaId;
  console.log();
...
var editarRespostaBtns = document.querySelectorAll('.bteditresp');
editarRespostaBtns.forEach(function (elemento) {
...
var deleteRespostaBtns = document.querySelectorAll('.btdeleteresp');
deleteRespostaBtns.forEach(function (elemento) {
  elemento.addEventListener('click', function (evento) {
    var id = elemento.getAttribute('id').split('_').pop();
    var confirmar = confirm('Tem a certeza que quer remover esta Resposta?');

    if (confirmar) {
      var linha = elemento.parentElement.parentElement;
      console.log(linha);
      axios["delete"]("/respostas/delete/".concat(id), {}).then(function (response) {
        console.log(response);
        linha.remove();
      })["catch"](function (error) {
        console.log(error);
