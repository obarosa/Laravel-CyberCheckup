...
"use strict";
/*!***********************************************!*\
  !*** ./resources/js/frontoffice/resultado.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
...
chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart.register.apply(chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart, _toConsumableArray(chart_js__WEBPACK_IMPORTED_MODULE_1__.registerables)); // Gráfico dos resultados

var ctx = document.getElementById('myChart').getContext('2d');
axios__WEBPACK_IMPORTED_MODULE_0___default().get('/resultados').then(function (response) {
  // console.log(response.data)
  var categorias = response.data[0];
...
axios__WEBPACK_IMPORTED_MODULE_0___default().get('/isguest', {}).then(function (response) {
  console.log(response.data);
  var colRight = document.querySelector('.bg-resultados-right');

  if (response.data !== 1) {
    colRight.style.display = 'none';
    var modalGuest = new bootstrap.Modal(document.getElementById('modalSubmeter'));
    modalGuest.show();
    var modalSubmeter = {
    ...
    modalSubmeter.btnSubmeter.addEventListener('click', function () {
      var nome = modalSubmeter.inputNome;
      var contacto = modalSubmeter.inputContacto;
      var email = modalSubmeter.inputEmail;
      ...
      if (nome.value !== null && contacto.value !== null && email.value !== null && nome.value !== '' && contacto.value !== '' && email.value !== '') {
        if (contacto.value.length == 9 || contacto.value.length == 13) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_0___default().post('/resultadoGuest', {
            'nome': nome.value,
