...
(() => {
/*!***********************************************!*\
  !*** ./resources/js/backoffice/categorias.js ***!
  \***********************************************/
/* provided dependency */ var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var DataTable = __webpack_require__(/*! datatables.net */ "./node_modules/datatables.net/js/jquery.dataTables.js"); // const Sortable = require('sortablejs');
//Modal


var modalGuardarCategoria = {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var table = document.getElementById('tableCategorias');
...
$(document).ready(function () {
  $.noConflict(); //datatable para paginação
  ...
  }); //datatable para ordering

  var el = document.getElementById('row_position');
  ...
  function updateOrder(aData) {
    axios.post('/categorias/order', {
      ...
      var linhaOrdemCat = document.querySelectorAll('.linhaOrdemCat');
      var i = 1;
      linhaOrdemCat.forEach(function (e) {
...
modalGuardarCategoria.btn.guardar.addEventListener('click', function () {
  var nome = modalGuardarCategoria.inputNome;
  var categoriaId; //Vê se uma categoria está a ser criada ou editada a partir do id
...
var editarCategoriaBtns = document.querySelectorAll('.bteditcat');
editarCategoriaBtns.forEach(function (elemento) {
  elemento.addEventListener('click', function (evento) {
    ...
    axios.get("/getcategoria/".concat(id), {}).then(function (response) {
...
var deleteCategoriaBtns = document.querySelectorAll('.btdeletecat');
deleteCategoriaBtns.forEach(function (elemento) {
  elemento.addEventListener('click', function (evento) {
    var id = elemento.getAttribute('id').split('_').pop();
    var confirmar = confirm('Tem a certeza que quer remover esta Categoria?\nATENÇÃO: TODAS as Questões e Respostas associadas SERÃO ELIMINADAS');

    if (confirmar) {
      var linha = elemento.parentElement.parentElement;
      console.log(linha);
      axios["delete"]("/categorias/delete/".concat(id), {}).then(function (response) {
        console.log(response);
        linha.remove();
      })["catch"](function (error) {
        console.log(error);
