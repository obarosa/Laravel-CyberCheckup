...
(() => {
/*!**************************************************!*\
  !*** ./resources/js/frontoffice/questionario.js ***!
  \**************************************************/
var bootstrap = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js"); // colocar botão submeter disponivel


var divPerguntas = document.querySelectorAll('#divPerguntas');
var submitQuestoes = document.querySelector('.submitQuestButton');
var spanSubmitQuestButton = document.querySelector('.spanSubmitQuestButton');
var obrigatorios = document.querySelectorAll('.obgt');
var multis = document.querySelectorAll('.multi');
var arrObgt = [];
obrigatorios.forEach(function (e) {
  arrObgt.push(e);
  e.addEventListener('change', function () {
    if (e.classList.contains('multi')) {} else {
      e.classList.remove('obgt');
    }
  });
});
multis.forEach(function (e) {
  if (e.classList.contains('obgt')) {
    e.addEventListener('change', function () {
      var arrMultis = e.children[2].children;
      var childrenArrMultis = [];

      for (var j = 0; j < arrMultis.length; j++) {
...
divPerguntas.forEach(function (elemento) {
  elemento.addEventListener('change', function () {
    for (var i = 0; i < arrObgt.length; i++) {
